          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <p className="mt-1.5 text-muted-foreground">
                {tab === "login" ? "Sign in to your account or create a new one" : "Fill in the details below to get started"}
              </p>
            </div>
            ...
            <div className="flex bg-muted rounded-xl p-1 mb-8">
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${tab === "login" ? "bg-white text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`}
              >
                Login
              </button>
              <button
                onClick={() => setTab("register")}
                className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${tab === "register" ? "bg-white text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`}
              >
                Register
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                {loading ? "Creating Account..." : tab === "login" ? "Sign In" : "Create Account"}
              </Button>
